 ...
 */
@Mapper
public interface MysqlAuditHandoverModelMapper {

    /**
     * SELECT 操作: selectAuditHandoverModel
     */
    List<AuditHandoverModel> selectAuditHandoverModel();
